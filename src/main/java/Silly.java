...
public class Silly implements Comparable<Silly>{
     ...
     * @param flavor the description of flavor for this Silly object
     * @param food the type of food for this Silly object
     */

    public Silly(String flavor, String food) {this.name = flavor + food; }
